        ...
        enablePartialDataSend: function (t) {
            ...
            if (t) {
                ...
                if ("GET" == this._tMode) a.query({
                    ...
                    var l = this.getState(e), h = r.replace(/(\&|\?)editing\=true/, ""), d = "", c = "post";
    ...
    Scheduler.plugin = function (t) {
        ...
        t._commonErrorMessages = {
            unknownView: function (t) {
                var n = "Related docs: " + e[t] || e.anythingElse,
                    a = i[t] ? "You're probably missing " + i[t] + "." : "";
        ...
        }, dhtmlxEventable(t), t._detachDomEvent = function (t, e, i) {
            ...
            t.event(window, "resize", function () {
                e(t._obj) && (window.clearTimeout(t._resize_timer),
                    t._resize_timer = window.setTimeout(function () {
                        var r = i();
                        if (!n(a, r)) {
                            if (!e(t._obj)) return;
            ...
            i = i || t._currentDate(), n = n || "week", this._obj && this.unset_actions(), this._obj = "string" == typeof e ? document.getElementById(e) : e, this.$container = this._obj,
            !this.$container.offsetHeight && this.$container.offsetWidth && "100%" === this.$container.style.height && window.console.error(t._commonErrorMessages.collapsedContainer(), this.$container), this.config.wai_aria_attributes && this.config.wai_aria_application_role && this.$container.setAttribute("role", "application"), this._skin_init && t._skin_init(), t.date.init(), this._els = [], this._scroll = !0, this._quirks = this.$env.isIE && "BackCompat" == document.compatMode,
                this._quirks7 = this.$env.isIE && -1 == navigator.appVersion.indexOf("MSIE 8"), this.get_elements(), this.init_templates(), this.set_actions(), this._init_once(), this._init_touch_events(), this.set_sizes(), t.callEvent("onSchedulerReady", []), this.setCurrentView(i, n)
        }, t.xy = {
            min_event_height: 40,
            scale_width: 50,
            scroll_width: 18,
        ...
        }, t.keys = {edit_save: 13, edit_cancel: 27},
            t.bind = function (t, e) {
            ...
            t._is_material_skin() ? (r || (r = document.createElement("div"), r.className = "dhx_cal_scale_placeholder",
                this.$container.insertBefore(r, this._els.dhx_cal_header[0])), r.style.display = "block", this.set_xy(r, e, this.xy.scale_height + 1, 0, this.xy.nav_height + (this._quirks ? -1 : 1))) : r && r.parentNode.removeChild(r), this.set_xy(this._els.dhx_cal_navline[0], e, this.xy.nav_height, 0, 0), this.set_xy(this._els.dhx_cal_header[0], e - n, this.xy.scale_height, a, this.xy.nav_height + (this._quirks ? -1 : 1));
        ...
        }, t.set_xy = function (t, e, i, n, a) {
            t.style.width = Math.max(0, e) + "px", t.style.height = Math.max(0, i) + "px", arguments.length > 3 && (t.style.left = n + "px", t.style.top = a + "px")
        }, t.get_elements = function () {
            for (var e = this._obj.getElementsByTagName("DIV"), i = 0; i < e.length; i++) {
                var n = t._getClassName(e[i]), a = e[i].getAttribute("name") || "";
                n && (n = n.split(" ")[0]), this._els[n] || (this._els[n] = []),
                    this._els[n].push(e[i]);
                var r = t.locale.labels[a || n];
                "string" != typeof r && a && !e[i].innerHTML && (r = a.split("_")[0]), r && (this._waiAria.labelAttr(e[i], r), e[i].innerHTML = r)
            }
            ...
            this._obj.onselectstart = function (t) {
                ...
                this._obj.oncontextmenu = function (e) {
                    var i = e || event, n = i.target || i.srcElement;
                    return t.callEvent("onContextMenu", [t._locate_event(n), i])
                }
        }, t.select = function (e) {
            ...
            dhx_cal_data: function (e) {
                ...
                var i = e ? e.target : event.srcElement, n = t._locate_event(i);
                if (e = e || event, n) {
                    if (!t.callEvent("onClick", [n, e]) || t.config.readonly) return
                } else t.callEvent("onEmptyClick", [t.getActionData(e).date, e]);
                if (n && t.config.select) {
                    t.select(n);
                    var a = t._getClassName(i);
                    -1 != a.indexOf("_icon") && t._click.buttons[a.split(" ")[1].replace("icon_", "")](n)
                ...
                var e = this.getAttribute("name"), i = e.substring(0, e.search("_tab"));
        ...
        }, t.addEventNow = function (e, i, n) {
            var a = {};
            t._isObject(e) && !t._isDate(e) && (a = e, e = null);
            var r = 6e4 * (this.config.event_duration || this.config.time_step);
            e || (e = a.start_date || Math.round(t._currentDate().valueOf() / r) * r);
            var s = new Date(e);
            if (!i) {
            ...
            var _ = this.addEvent(a);
            return this.callEvent("onEventCreated", [this._drag_id, n]), this._loading = !1, this._drag_event = {}, this._on_mouse_up(n), _
        },
            t._on_dbl_click = function (e, i) {
                if (i = i || e.target || e.srcElement, !this.config.readonly) {
                    var n = t._getClassName(i).split(" ")[0];
                    switch (n) {
                        ...
                        case"dhx_cal_container":
                            return;
                        default:
                            var r = this["dblclick_" + n];
                            if (r) r.call(this, e); else if (i.parentNode && i != this) return t._on_dbl_click(e, i.parentNode)
                    }
                }
            ...
            var i, n = document.body, a = document.documentElement;
            i = this.$env.isIE || !e.pageX && !e.pageY ? {
                x: e.clientX + (n.scrollLeft || a.scrollLeft || 0) - n.clientLeft,
                y: e.clientY + (n.scrollTop || a.scrollTop || 0) - n.clientTop
            } : {
                x: e.pageX,
                y: e.pageY
            ...
            ;
            if (r) i = r.call(this, i); else if (this._table_view) {
                ...
                i.y = Math.ceil(24 * (Math.max(0, s) + 7 * Math.max(0, o - 1)) * 60 / this.config.time_step), (t._drag_mode || "month" == this._mode) && (i.y = 24 * (Math.max(0, Math.ceil(s) - 1) + 7 * Math.max(0, o - 1)) * 60 / this.config.time_step), "move" == this._drag_mode && t._ignores_detected && t.config.preserve_length && (i._ignores = !0,
            ...
            t._correct_drag_start_date = function (e) {
                var i;
                t.matrix && (i = t.matrix[t._mode]), i = i || {x_step: 1, x_unit: "day"}, e = new Date(e);
                var n = 1;
                return (i._start_correction || i._end_correction) && (n = 60 * (i.last_hour || 0) - (60 * e.getHours() + e.getMinutes()) || 1), 1 * e + (t._get_fictional_event_length(e, n, i) - n)
            }, t._correct_drag_end_date = function (e, i) {
            var n;
            t.matrix && (n = t.matrix[t._mode]), n = n || {x_step: 1, x_unit: "day"};
            var a = 1 * e + t._get_fictional_event_length(e, i, n);
            return new Date(1 * a - (t._get_fictional_event_length(a, -1, n, -1) + 1))
            ...
            if (this._drag_mode) {
                ...
                if (this._is_pos_changed(this._drag_pos, i)) {
                    ...
                    if (this._drag_pos && !this._drag_pos.has_moved && (r = this._drag_pos, r.has_moved = !0), this._drag_pos = i, this._drag_pos.has_moved = !0, "create" == this._drag_mode) {
                        if (r && (i = r), this._close_not_saved(), this.unselect(this._select_id), this._loading = !0, n = this._get_date_from_pos(i).valueOf(),
                            !this._drag_start) {
                            return this.callEvent("onBeforeEventCreated", [e, this._drag_id]) ? (this._loading = !1, void (this._drag_start = n)) : void (this._loading = !1)
                        }
                        a = n, this._drag_start;
                        var s = new Date(this._drag_start), o = new Date(a);
                        "day" != this._mode && "week" != this._mode || s.getHours() != o.getHours() || s.getMinutes() != o.getMinutes() || (o = new Date(this._drag_start + 1e3)), this._drag_id = this.uid(), this.addEvent(s, o, this.locale.labels.new_event, this._drag_id, i.fields), this.callEvent("onEventCreated", [this._drag_id, e]),
                    ...
                    if (t.matrix && (d = t.matrix[t._mode]), d = d || {
                        x_step: 1,
                        x_unit: "day"
                    }, "move" == this._drag_mode) n = this._min_date.valueOf() + 6e4 * (i.y * this.config.time_step + 24 * i.x * 60), !i.custom && this._table_view && (n += 1e3 * this.date.time_part(_.start_date)), !this._table_view && this._dragEventBody && void 0 === this._drag_event._move_event_shift && (this._drag_event._move_event_shift = n - _.start_date),
                    this._drag_event._move_event_shift && (n -= this._drag_event._move_event_shift), n = this._correct_shift(n), i._ignores && this.config.preserve_length && this._table_view ? (n = t._correct_drag_start_date(n), a = t._correct_drag_end_date(n, this._drag_event._event_length)) : a = _.end_date.valueOf() - (_.start_date.valueOf() - n); else {
                        if (n = _.start_date.valueOf(), a = _.end_date.valueOf(), this._table_view) {
                            ...
                            if ("month" == this._mode) if (l = this._correct_shift(l, !1), this._drag_from_start) {
                                var h = 864e5;
                                l <= t.date.date_part(new Date(a + h - 1)).valueOf() && (n = l - h)
                            } else a = l; else this.config.preserve_length ? i.resize_from_start ? n = t._correct_drag_start_date(l) : a = t._correct_drag_end_date(l, 0) : i.resize_from_start ? n = l : a = l
                        } else {
                            var c = this.date.date_part(new Date(_.end_date.valueOf() - 1)).valueOf(), u = new Date(c);
                            a = c + i.y * this.config.time_step * 6e4, a += 6e4 * (new Date(a).getTimezoneOffset() - u.getTimezoneOffset()),
                                this._els.dhx_cal_data[0].style.cursor = "s-resize", "week" != this._mode && "day" != this._mode || (a = this._correct_shift(a))
                        }
                        if ("new-size" == this._drag_mode) if (a <= this._drag_start) {
                            var g = i.shift || (this._table_view && !i.custom ? 864e5 : 0);
                            n = a - (i.shift ? 0 : g), a = this._drag_start + (g || 6e4 * this.config.time_step)
                        } else n = this._drag_start; else a <= n && (a = n + 6e4 * this.config.time_step)
                    }
                    var f = new Date(a - 1), v = new Date(n);
                    if ("move" == this._drag_mode && t.config.limit_drag_out && (+v < +t._min_date || +a > +t._max_date)) {
                        if (+_.start_date < +t._min_date || +_.end_date > +t._max_date) v = new Date(_.start_date), a = new Date(_.end_date); else {
                            var m = a - v;
                            +v < +t._min_date ? (v = new Date(t._min_date), i._ignores && this.config.preserve_length && this._table_view ? (v = new Date(t._correct_drag_start_date(v)), d._start_correction && (v = new Date(v.valueOf() + d._start_correction)), a = new Date(1 * v + this._get_fictional_event_length(v, this._drag_event._event_length, d))) : a = new Date(+v + m)) : (a = new Date(t._max_date),
                                i._ignores && this.config.preserve_length && this._table_view ? (d._end_correction && (a = new Date(a.valueOf() - d._end_correction)), a = new Date(1 * a - this._get_fictional_event_length(a, 0, d, !0)), v = new Date(1 * a - this._get_fictional_event_length(a, this._drag_event._event_length, d, !0)), this._ignores_detected && (v = t.date.add(v, d.x_step, d.x_unit), a = new Date(1 * a - this._get_fictional_event_length(a, 0, d, !0)), a = t.date.add(a, d.x_step, d.x_unit))) : v = new Date(+a - m))
                        }
                        var f = new Date(a - 1)
                    }
                    if (!this._table_view && this._dragEventBody && !t.config.all_timed && (!t._get_section_view() && i.x != this._get_event_sday({
                        ...
                        if ("move" == this._drag_mode) {
                            ...
                            v = new Date(h), v.setHours(this.config.first_hour), a = new Date(v.valueOf() + m), f = new Date(a - 1)
                        }
                    }
                    if (!this._table_view && !t.config.all_timed && (!t.getView() && i.x != this._get_event_sday({
                        ...
                        var m = a - v, h = this._min_date.valueOf() + 24 * i.x * 60 * 6e4;
                        a = t.date.date_part(new Date(h)), a.setHours(this.config.last_hour), f = new Date(a - 1), "move" == this._drag_mode && (v = new Date(+a - m))
                    }
                    if (this._table_view || f.getDate() == v.getDate() && f.getHours() < this.config.last_hour || t._allow_dnd) if (_.start_date = v, _.end_date = new Date(a), this.config.update_render) {
                        var p = t._els.dhx_cal_data[0].scrollTop;
                        this.update_view(),
                            t._els.dhx_cal_data[0].scrollTop = p
            ...
            if (2 != e.button && !this.config.readonly && !this._drag_mode) {
                ...
                ;var n = t._getClassName(i).split(" ")[0];
                switch (this.config.drag_event_body && "dhx_body" == n && i.parentNode && -1 === i.parentNode.className.indexOf("dhx_cal_select_menu") && (n = "dhx_event_move", this._dragEventBody = !0), n) {
                    case"dhx_cal_event_line":
                    case"dhx_cal_event_clear":
                    ...
                    case"":
                        ...
                        break;
                    default:
                        if ((!t.checkEvent("onMouseDown") || t.callEvent("onMouseDown", [n, e])) && i.parentNode && i != this && "dhx_body" != n) return t._on_mouse_down(e, i.parentNode);
                        this._drag_mode = null,
                            this._drag_id = null
                }
                if (this._drag_mode) {
                    var a = this._locate_event(i);
                    if (this.config["drag_" + this._drag_mode] && this.callEvent("onBeforeDrag", [a, this._drag_mode, e])) {
            ...
            if (!e || 2 != e.button || !this._mobile) {
                if (this._drag_mode && this._drag_id) {
                    ...
                    var i = this._drag_id, n = this._drag_mode, a = !this._drag_pos || this._drag_pos.has_moved
                    ...
                    if (a && (this._drag_event._dhx_changed || !this._drag_event.start_date || r.start_date.valueOf() != this._drag_event.start_date.valueOf() || r.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                        ...
                        if (this.callEvent("onBeforeEventChanged", [r, e, s, this._drag_event])) if (this._drag_id = this._drag_mode = null, s && this.config.edit_on_create) {
                            ...
                            this._table_view || this.config.details_on_create || !this.config.select || !this.isOneDayEvent(this.getEvent(i))) return t.callEvent("onDragEnd", [i, n, e]), this.showLightbox(i);
                    ...
                    this._drag_pos && (this._drag_pos.has_moved || !0 === this._drag_pos) && (this._drag_id = this._drag_mode = null, this.render_view_data()), t.callEvent("onDragEnd", [i, n, e])
                }
            ...
            for (var t = ["dhx_cal_next_button", "dhx_cal_prev_button", "dhx_cal_tab", "dhx_cal_today_button"], e = 0; e < t.length; e++) for (var i = this._els[t[e]], n = 0; i && n < i.length; n++) {
                ...
                a && (r = this.locale.labels[a] || r),
                    "dhx_cal_next_button" == t[e] ? r = this.locale.labels.next : "dhx_cal_prev_button" == t[e] && (r = this.locale.labels.prev), this._waiAria.headerButtonsAttributes(i[n], r || "")
            }
            ...
            if (_) for (var l = 0; l < _.length; l++) {
                var h = _[l], c = h.className;
            ...
            t._render_x_header = function (t, e, i, n, a) {
                a = a || 0;
                var r = document.createElement("div");
            ...
            if (!t._table_view) {
                ...
                a && (i = a(e)), n = Math.round((i.valueOf() - e.valueOf()) / 864e5)
            }
            return n
        }, t._get_timeunit_start = function () {
            return this.date[this._mode + "_start"](new Date(this._date.valueOf()))
        }, t._get_view_end = function () {
            var e = this._get_timeunit_start(), i = t.date.add(e, 1, this._mode);
            if (!t._table_view) {
            ...
            var n = t, a = this._get_columns_num(e, i);
            this._process_ignores(e, a, "day", 1);
            for (var r = a - this._ignores_detected, s = 0; s < a; s++) this._ignores[s] ? (this._cols[s] = 0, r++) : this._cols[s] = Math.floor(n / (r - s)), n -= this._cols[s], this._colsS[s] = (this._cols[s - 1] || 0) + (this._colsS[s - 1] || (this._table_view ? 0 : this.xy.scale_width + 2));
            ...
            var n = new Date(t._min_date), a = new Date(t._max_date), r = this.date.date_part(t._currentDate()),
                s = parseInt(e.style.width, 10), o = new Date(this._min_date), d = this._get_columns_num(n, a);
            this._calc_scale_sizes(s, n, a);
            var _ = 0;
            e.innerHTML = "";
            for (var l = 0; l < d; l++) {
            ...
            if (this.templates[this._mode + "_date"]) {
                var e = this._els.dhx_cal_header[0], i = this._els.dhx_cal_data[0], n = this.config;
                e.innerHTML = "", i.innerHTML = "";
                var a = (n.readonly || !n.drag_resize ? " dhx_resize_denied" : "") + (n.readonly || !n.drag_move ? " dhx_move_denied" : "");
                i.className = "dhx_cal_data" + a, this._scales = {}, this._cols = [], this._colsS = {height: 0}, this._dy_shift = 0, this.set_sizes();
                var r, s, o = this._get_timeunit_start(), d = t._get_view_end();
                r = s = this._table_view ? t.date.week_start(o) : o, this._min_date = r
                ;var _ = this.templates[this._mode + "_date"](o, d, this._mode);
                if (this._els.dhx_cal_date[0].innerHTML = _, this._waiAria.navBarDateAttr(this._els.dhx_cal_date[0], _), this._max_date = d, t._render_scales(e, i), this._table_view) this._reset_month_scale(i, o, s); else if (this._reset_hours_scale(i, o, s), n.multi_day) {
                    var l = "dhx_multi_day";
            ...
            t._reset_hours_scale = function (e, i, n) {
                var a = document.createElement("div");
                ...
                for (var r = new Date(1980, 1, 1, this.config.first_hour, 0, 0), s = 1 * this.config.first_hour; s < this.config.last_hour; s++) {
                    ...
                    o.innerHTML = _,
                        this._waiAria.hourScaleAttr(o, _), a.appendChild(o), r = this.date.add(r, 1, "hour")
                }
        ...
        }, t._process_ignores = function (e, i, n, a, r) {
            this._reset_ignores();
            var s = t["ignore_" + this._mode]
            ;
            if (s) for (var o = new Date(e), d = 0; d < i; d++) s(o) && (this._ignores_detected += 1, this._ignores[d] = !0, r && i++), o = t.date.add(o, a, n), t.date[n + "_start"] && (o = t.date[n + "_start"](o))
        }, t._render_month_scale = function (e, i, n, a) {
            function r(e) {
                var i = t._colsS.height;
                return void 0 !== t._colsS.heights[e + 1] && (i = t._colsS.heights[e + 1] - (t._colsS.heights[e] || 0)), i
            }

            var s = t.date.add(i, 1, "month"), o = new Date(n), d = t._currentDate();
            this.date.date_part(d), this.date.date_part(n),
                a = a || Math.ceil(Math.round((s.valueOf() - n.valueOf()) / 864e5) / 7);
            for (var _ = [], l = 0; l <= 7; l++) {
            ...
            for (var f = [], l = 0; l < a; l++) {
                ...
                for (var m = Math.max(r(l) - t.xy.month_head_height, 0), p = 0; p < 7; p++) {
                    ...
                    v.appendChild(x);
                    var b = "";
                    n < i ? b = "dhx_before" : n >= s ? b = "dhx_after" : n.valueOf() == d.valueOf() && (b = "dhx_now"), this._ignores_detected && this._ignores[p] && (b += " dhx_scale_ignore"), x.className = b + " " + this.templates.month_date_class(n, d);
                    ...
                    if (0 === p && this.config.left_border && (y += " dhx_month_body_border", w += " dhx_month_head_border"), this._ignores_detected && this._ignores[p]) x.appendChild(document.createElement("div")),
                        x.appendChild(document.createElement("div")); else {
                        this._waiAria.monthCellAttr(x, n);
                        var D = document.createElement("div");
                        D.className = w, D.innerHTML = this.templates.month_day(n), x.appendChild(D);
                        var E = document.createElement("div");
                        E.className = y, E.style.height = m + "px", E.style.width = _[p], x.appendChild(E)
                    }
                    f.push(n);
                    var A = n.getDate();
                    n = this.date.add(n, 1, "day"), n.getDate() - A > 1 && (n = new Date(n.getFullYear(), n.getMonth(), A + 1, 12, 0))
                }
                t._colsS.heights[l] = c, c += r(l)
            }
            this._min_date = o, this._max_date = n,
        ...
        }, t._reset_month_scale = function (e, i, n, a) {
            var r = t.date.add(i, 1, "month"), s = t._currentDate();
            this.date.date_part(s), this.date.date_part(n), a = a || Math.ceil(Math.round((r.valueOf() - n.valueOf()) / 864e5) / 7)
            ;var o = Math.floor(e.clientHeight / a) - this.xy.month_head_height;
            return this._colsS.height = o + this.xy.month_head_height, this._colsS.heights = [], t._render_month_scale(e, i, n, a)
            ...
            t.updateCollection = function (e, i) {
                ...
                return !!n && (n.splice(0, n.length), n.push.apply(n, i || []), t.callEvent("onOptionsLoad", []), t.resetLightbox(), !0)
            }, t._lame_clone = function (e, i) {
            var n, a, r;
            for (i = i || [], n = 0; n < i.length; n += 2) if (e === i[n]) return i[n + 1];
            if (e && "object" == typeof e) {
                for (r = {}, a = [Array, Date, Number, String, Boolean], n = 0; n < a.length; n++) e instanceof a[n] && (r = n ? new a[n](e) : new a[n]);
                i.push(e, r);
                for (n in e) Object.prototype.hasOwnProperty.apply(e, [n]) && (r[n] = t._lame_clone(e[n], i))
            }
            return r || e
        ...
        }, t._get_real_event_length = function (e, i, n) {
            var a, r = i - e, s = n._start_correction + n._end_correction || 0, o = this["ignore_" + this._mode], d = 0;
            n.render ? (d = this._get_date_index(n, e), a = this._get_date_index(n, i)) : a = Math.round(r / 60 / 60 / 1e3 / 24);
            for (var _ = !0; d < a;) {
                var l = t.date.add(i, -n.x_step, n.x_unit);
                o && o(i) && (!_ || _ && o(l)) ? r -= i - l : (_ = !1, r -= s), i = l, a--
            }
            return r
        }, t._get_fictional_event_length = function (e, i, n, a) {
            var r = new Date(e), s = a ? -1 : 1
            ;
            if (n._start_correction || n._end_correction) {
                var o;
                o = a ? 60 * r.getHours() + r.getMinutes() - 60 * (n.first_hour || 0) : 60 * (n.last_hour || 0) - (60 * r.getHours() + r.getMinutes());
                var d = 60 * (n.last_hour - n.first_hour), _ = Math.ceil((i / 6e4 - o) / d);
                _ < 0 && (_ = 0), i += _ * (1440 - d) * 60 * 1e3
            }
            var l, h = new Date(1 * e + i * s), c = this["ignore_" + this._mode], u = 0;
            for (n.render ? (u = this._get_date_index(n, r), l = this._get_date_index(n, h)) : l = Math.round(i / 60 / 60 / 1e3 / 24); u * s <= l * s;) {
                var g = t.date.add(r, n.x_step * s, n.x_unit);
            ...
            function e(e) {
                ...
                if (window.getComputedStyle) {
                    ...
                    i = a.display, n = a.visibility
                } else e.currentStyle && (i = e.currentStyle.display,
                    n = e.currentStyle.visibility);
                var r = !1, s = t._locate_css({target: e}, "dhx_form_repeat", !1);
                return s && (r = !("0px" != s.style.height)), r = r || !e.offsetHeight, "none" != i && "hidden" != n && !r
            }
            ...
            t._getFocusableNodes = function (t) {
                for (var r = t.querySelectorAll(["a[href]", "area[href]", "input", "select", "textarea", "button", "iframe", "object", "embed", "[tabindex]", "[contenteditable]"].join(", ")), s = Array.prototype.slice.call(r, 0), o = 0; o < s.length; o++) {
                    var d = s[o];
                    (i(d) || a(d) || n(d)) && e(d) || (s.splice(o, 1), o--)
                }
                return s
            }
        }(), t._trim = function (t) {
            ...
            t._waiAria = {
                getAttributeString: function (t) {
                    var n = [" "];
                    for (var a in t) if ("function" != typeof t[a] && "object" != typeof t[a]) {
                        var r = i(e(t[a]));
                        n.push(a + "='" + r + "'")
                    }
                    return n.push(" "), n.join(" ")
                }, setAttributes: function (t, i) {
                    for (var n in i) t.setAttribute(n, e(i[n]));
                    return t
                ...
                }, _eventCommonAttr: function (i, n) {
                    n.setAttribute("aria-label", e(t.templates.event_text(i.start_date, i.end_date, i))), t.config.readonly && n.setAttribute("aria-readonly", !0), i.$dataprocessor_class && n.setAttribute("aria-busy", !0), n.setAttribute("aria-selected", t.getState().select_id == i.id ? "true" : "false")
                    ...
                    var n = i.valueOf() < t._max_date.valueOf() && i.valueOf() >= t._min_date.valueOf();
                    ...
                    var n = e.querySelector(".dhx_wa_scale_bar"), a = e.querySelector(".dhx_wa_day_data"),
                        r = t.uid() + "";
                    this.setAttributes(n, {id: r}), this.setAttributes(a, {"aria-labelledby": r})
                ...
                yearDayCell: function (t) {
                    ...
                    return this.getAttributeString({role: "button", "aria-label": t.locale.labels[e]})
            ...
            getOffsetRect: function (t) {
                ...
                if (/Mobi/.test(navigator.userAgent)) {
                    ...
                    var s = document.body, o = document.documentElement,
                        ...
                        _ = window.pageXOffset || o.scrollLeft || s.scrollLeft, l = o.clientTop || s.clientTop || 0,
        ...
        var n;
        if (Element.prototype.closest) n = function (t, e) {
            return t.closest(e)
        }; else {
        ...
        t.$env = {
            ...
            _obj: t, cache: !0, method: "get", parse: function (e) {
                ...
                }), "GET" != t || this.cache || (e += (e.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (new Date).getTime() + "=1"), d.open(t, e, n), s) for (var l in s) d.setRequestHeader(l, s[l]); else "POST" == t.toUpperCase() || "PUT" == t || "DELETE" == t ? d.setRequestHeader("Content-Type", "application/x-www-form-urlencoded") : "GET" == t && (i = null);
        ...
        t.date = {
            ...
            day_start: function (t) {
                ...
                return t.date._bind_host_object(n)
            }, str_to_date: function (e, i, n) {
                var a = r(e, i),
                    ...
                    l = function (t) {
                        ...
                        return _.test(t)
                    }, g = r("%Y-%m-%d %H:%i:%s", i), f = r("%m/%d/%Y %H:%i:%s", i), v = r("%d-%m-%Y %H:%i:%s", i);
                return function (e) {
            ...
            var i = t.date.date_to_str, n = t.config;
            (function (t, e) {
                for (var i in e) t[i] || (t[i] = e[i])
            })(t.templates, {
                day_date: i(n.default_date),
                month_date: i(n.month_date),
                week_date: function (e, i) {
                    return t.templates.day_date(e) + " &ndash; " + t.templates.day_date(t.date.add(i, -1, "day"))
                },
                day_scale_date: i(n.default_date),
                month_scale_date: i(n.week_date),
                week_scale_date: i(n.day_date),
                hour_scale: i(n.hour_date),
                time_picker: i(n.hour_date),
                event_date: i(n.hour_date),
                month_day: i(n.month_day),
                load_format: i(n.load_date),
                format_date: i(n.date_format, n.server_utc),
                parse_date: t.date.str_to_date(n.date_format, n.server_utc),
                api_date: t.date.str_to_date(n.api_date, !1, !1),
                event_header: function (e, i, n) {
                ...
                tooltip_text: function (e, i, n) {
                    return "<b>Event:</b> " + n.text + "<br/><b>Start date:</b> " + t.templates.tooltip_date_format(e) + "<br/><b>End date:</b> " + t.templates.tooltip_date_format(i)
                }
        ...
        }, t.addEvent = function (e, i, n, a, r) {
            if (!arguments.length) return this.addEventNow();
            var s = e;
            1 != arguments.length && (s = r || {}, s.start_date = e, s.end_date = i, s.text = n, s.id = a),
            ...
            function () {
                for (var e = ["text", "Text", "start_date", "StartDate", "end_date", "EndDate"], i = function (e) {
                    ...
                    return function (i, n) {
                        var a = t.getEvent(i);
                        a[e] = n, a._changed = !0, a._timed = this.isOneDayEvent(a), t.event_updated(a, !0)
                    }
                }, a = 0; a < e.length; a += 2) t["getEvent" + e[a + 1]] = i(e[a]), t["setEvent" + e[a + 1]] = n(e[a])
            ...
            t._is_main_area_event = function (t) {
                return !!t._timed
            }, t.render_view_data = function (e, i) {
            var n = !1;
            if (!e) {
                if (n = !0, this._not_render) return void (this._render_wait = !0);
                this._render_wait = !1, this.clear_view(), e = this.get_visible_events(!(this._table_view || this.config.multi_day))
            }
            for (var a = 0, r = e.length; a < r; a++) this._recalculate_timed(e[a]);
            if (this.config.multi_day && !this._table_view) {
                for (var s = [], o = [], a = 0; a < e.length; a++) this._is_main_area_event(e[a]) ? s.push(e[a]) : o.push(e[a]);
                if (!this._els.dhx_multi_day) {
                    var d = t._commonErrorMessages.unknownView(this._mode);
                    throw new Error(d)
                }
                this._rendered_location = this._els.dhx_multi_day[0], this._table_view = !0, this.render_data(o, i), this._table_view = !1, this._rendered_location = this._els.dhx_cal_data[0], this._table_view = !1, this.render_data(s, i)
            } else {
                var _ = document.createDocumentFragment(), l = this._els.dhx_cal_data[0];
                this._rendered_location = _, this.render_data(e, i), l.appendChild(_), this._rendered_location = l
            }
            ...
            for (var i = this._rendered_location, n = this._lame_clone(e), a = e._sday; a < e._eday; a++) {
                n._sday = a, n._eday = a + 1;
                var r = t.date, s = t._min_date;
                s = r.add(s, n._sweek, "week"), s = r.add(s, n._sday, "day");
                var o = t.getEvents(s, r.add(s, 1, "day")).length, d = this._get_event_bar_pos(n), _ = d.x2 - d.x,
                    l = document.createElement("div");
                l.onclick = function (e) {
                    t._view_month_day(e || event)
                }, l.className = "dhx_month_link", l.style.top = d.y + "px", l.style.left = d.x + "px", l.style.width = _ + "px", l.innerHTML = t.templates.month_events_link(s, o), this._rendered.push(l), i.appendChild(l)
            }
            ...
            ;
            for (var n = {}, a = 0; a < e.length; a++) if (this._table_view) if ("month" != t._mode) this.render_event_bar(e[a]); else {
                var r = t.config.max_month_events;
                r !== 1 * r || e[a]._sorder < r ? this.render_event_bar(e[a]) : void 0 !== r && e[a]._sorder == r && t._render_month_link(e[a])
            } else {
                var s = e[a], o = t.locate_holder(s._sday);
                if (!o) continue;
                n[s._sday] || (n[s._sday] = {real: o, buffer: document.createDocumentFragment(), width: o.clientWidth});
                var d = n[s._sday];
            ...
            var n = this.xy.bar_height, a = this._colsS.heights, r = this._colsS.heights = [0, 0, 0, 0, 0, 0, 0],
                s = this._els.dhx_cal_data[0];
            if (e = this._table_view ? this._pre_render_events_table(e, i) : this._pre_render_events_line(e, i), this._table_view) if (i) this._colsS.heights = a; else {
                var o = s.firstChild;
                if (o.rows) {
                    for (var d = 0; d < o.rows.length; d++) {
                        r[d]++;
                        var _ = o.rows[d].cells, l = this._colsS.height - this.xy.month_head_height;
                        if (r[d] * n > l) {
                            var h = l;
                            1 * this.config.max_month_events !== this.config.max_month_events || r[d] <= this.config.max_month_events ? h = r[d] * n : (this.config.max_month_events + 1) * n > l && (h = (this.config.max_month_events + 1) * n);
                    ...
                    o.parentNode.offsetHeight < o.parentNode.scrollHeight && !t._colsS.scroll_fix && t.xy.scroll_width) {
                        var u = t._colsS, g = u[u.col_length], f = u.heights.slice();
                    ...
                    var v = (o.parentNode.childNodes, (r[0] + 1) * n + 1), m = v, p = v + "px";
            ...
            for (var a = 0; a < t.length; a++) {
                var r = t[a], s = r.start_date, o = r.end_date, d = s.getHours(), _ = o.getHours();
                if (r._sday = this._get_event_sday(r), this._ignores[r._sday]) t.splice(a, 1), a--; else {
                    if (i[r._sday] || (i[r._sday] = []), !e) {
                        ...
                        for (var l = i[r._sday]; l.length;) {
                            var h = l[l.length - 1], c = this._get_event_mapped_end_date(h);
                            if (!(c.valueOf() <= r.start_date.valueOf())) break;
                            l.splice(l.length - 1, 1)
                        }
                        for (var u = l.length, g = !1, f = 0; f < l.length; f++) {
                            var h = l[f], c = this._get_event_mapped_end_date(h);
                            if (c.valueOf() <= r.start_date.valueOf()) {
                                g = !0, r._sorder = h._sorder, u = f, r._inner = !0;
                                break
                            }
                        }
                        if (l.length && (l[l.length - 1]._inner = !0), !g) if (l.length) if (l.length <= l[l.length - 1]._sorder) {
        ...
        }, t._is_any_multiday_cell_visible = function (e, i, n) {
            for (var a = this._cols.length, r = !1, s = e, o = !0; s < i;) {
                o = !1;
                var d = this.locate_holder_day(s, !1, n), _ = d % a;
                if (!this._ignores[_]) {
                    r = !0;
                    break
                }
            ...
            this._time_order(e)
            ;
            for (var n, a = [], r = [[], [], [], [], [], [], []], s = this._colsS.heights, o = this._cols.length, d = {}, _ = 0; _ < e.length; _++) {
                var l = e[_], h = l.id;
                d[h] || (d[h] = {first_chunk: !0, last_chunk: !0});
                var c = d[h], u = n || l.start_date, g = l.end_date;
                ...
                if (l._sday = f % o, !this._ignores[l._sday] || !l._timed) {
                    ...
                    if (t._is_any_multiday_cell_visible(u, g, l)) {
                        ...
                        if (l._sorder && i || (l._sorder = m), l._sday + l._length <= o) n = null, a.push(l), p[m] = l, s[l._sweek] = p.length - 1, l._first_chunk = c.first_chunk, l._last_chunk = c.last_chunk; else {
                            var x = this._copy_event(l);
                            x.id = l.id, x._length = o - l._sday, x._eday = o, x._sday = l._sday, x._sweek = l._sweek, x._sorder = l._sorder,
                                x.end_date = this.date.add(u, x._length, "day"), x._first_chunk = c.first_chunk, c.first_chunk && (c.first_chunk = !1), a.push(x), p[m] = x, n = x.end_date, s[l._sweek] = p.length - 1, _--
                        }
                    }
                }
            }
            ...
            var n = 60 * e.start_date.getHours() + e.start_date.getMinutes(),
                a = 60 * e.end_date.getHours() + e.end_date.getMinutes() || 60 * t.config.last_hour;
            return {
                top: this._y_from_date(e.start_date),
                height: Math.max(i, (a - n) * this.config.hour_size_px / 60)
            }
        }, t.render_event = function (e, i, n) {
            var a = t.xy.menu_width, r = this.config.use_select_menu_space ? 0 : a;
            if (!(e._sday < 0)) {
                var s = t.locate_holder(e._sday);
                if (s) {
                    i = i || s;
                    var o = this._calc_event_y(e, t.xy.min_event_height), d = o.top, _ = o.height, l = e._count || 1,
                        h = e._sorder || 0;
                    n = n || s.clientWidth;
                    var c = Math.floor((n - r) / l), u = h * c + 1;
                    if (e._inner || (c *= l - h), this.config.cascade_event_display) {
                        var g = this.config.cascade_event_count, f = this.config.cascade_event_margin;
                        u = h % g * f
                        ;var v = e._inner ? (l - h - 1) % g * f / 2 : 0;
                        c = Math.floor(n - r - u - v)
                    }
                    ...
                    if (0 !== this.xy.menu_width && this._select_id == e.id) {
                        ...
                        ;
                        var S = this._render_v_bar(e, u - a + 1, d, a, 20 * y.length + 26 - 2, "", "<div style='" + D + E + "' class='dhx_menu_head'></div>", w, !0);
                        S.style.left = u - a + 1, this._els.dhx_cal_data[0].appendChild(S), this._rendered.push(S)
                    }
                    this.config.drag_highlight && this._drag_id == e.id && this.highlightEventPosition(e)
                }
            }
        }, t._render_v_bar = function (e, i, n, a, r, s, o, d, _) {
            var l = document.createElement("div"), h = e.id,
                c = _ ? "dhx_cal_event dhx_cal_select_menu" : "dhx_cal_event", u = t.getState();
            ...
            ;var f = e.color ? "background-color:" + e.color + ";" : "",
                v = e.textColor ? "color:" + e.textColor + ";" : "", m = t._border_box_bvents(), p = a - 2,
                x = m ? p : a - 4, b = m ? p : a - 6, y = m ? p : a - (this._quirks ? 4 : 14), w = m ? p - 2 : a - 8,
                D = m ? r - this.xy.event_header_height - 1 : r - (this._quirks ? 20 : 30) + 1,
                E = '<div event_id="' + h + '" class="' + c + '" style="position:absolute; top:' + n + "px; left:" + i + "px; width:" + x + "px; height:" + r + "px;" + (s || "") + '"></div>';
            l.innerHTML = E;
            var A = l.cloneNode(!0).firstChild;
            if (!_ && t.renderEvent(A, e, a, r, o, d)) return A;
            A = l.firstChild
            ...
            t._get_event_bar_pos = function (e) {
                var i = this._colsS[e._sday], n = this._colsS[e._eday];
                n == i && (n = this._colsS[e._eday + 1]);
            ...
            var i = this._rendered_location, n = this._get_event_bar_pos(e), a = n.y, r = n.x, s = n.x2, o = "";
            if (s) {
                var d = t.config.resize_month_events && "month" == this._mode && (!e._timed || t.config.resize_month_timed),
                    _ = document.createElement("div"), l = e.hasOwnProperty("_first_chunk") && e._first_chunk,
                    h = e.hasOwnProperty("_last_chunk") && e._last_chunk, c = d && (e._timed || l),
                    u = d && (e._timed || h), g = "dhx_cal_event_clear";
                ...
                var v = e.color ? "background:" + e.color + ";" : "",
                    ...
                    p = ["position:absolute", "top:" + a + "px", "left:" + r + "px", "width:" + (s - r - 15) + "px", m, v, e._text_style || ""].join(";"),
            ...
            if (e) {
                for (var i = t._rendered, n = 0; n < i.length; n++) {
                    var a = i[n];
            ...
            var n = "number" == typeof e || "string" == typeof e ? t.getEvent(e) : e;
            if (i = i || t._mode, n && (!this.checkEvent("onBeforeEventDisplay") || this.callEvent("onBeforeEventDisplay", [n, i]))) {
                var a = t.config.scroll_hour;
                t.config.scroll_hour = n.start_date.getHours();
                var r = t.config.preserve_scroll;
                t.config.preserve_scroll = !1;
                var s = n.color, o = n.textColor;
                if (t.config.highlight_displayed_event && (n.color = t.config.displayed_event_color, n.textColor = t.config.displayed_event_text_color),
                    t.setCurrentView(new Date(n.start_date), i), n.color = s, n.textColor = o, t.config.scroll_hour = a, t.config.preserve_scroll = r, t.matrix && t.matrix[i]) {
                    var d = t.getView(), _ = d.y_property, l = t.getEvent(n.id);
                    if (l) {
                        var h = d.posFromSection(l[_]), c = d.posFromDate(l.start_date),
                ...
                t.callEvent("onAfterEventDisplay", [n, i])
            }
        }, t._append_drag_marker = function (e) {
            if (!e.parentNode) {
                var i = t._els.dhx_cal_data[0], n = i.lastChild, a = t._getClassName(n);
                a.indexOf("dhx_scale_holder") < 0 && n.previousSibling && (n = n.previousSibling), a = t._getClassName(n), n && 0 === a.indexOf("dhx_scale_holder") && n.appendChild(e)
            }
        }, t._update_marker_position = function (e, i) {
            var n = t._calc_event_y(i, 0);
            e.style.top = n.top + "px", e.style.height = n.height + "px"
            ...
            if (e = e || this._load_url) {
                ...
                if (i = i || this._date,
                    ...
                    a = i;
                    for (var s = !0; a < this._max_date;) a = this.date.add(a, 1, this._load_mode), this._loaded[r(i)] && s ? i = this.date.add(i, 1, this._load_mode) : s = !1;
                    var o = a;
                    do {
                        a = o, o = this.date.add(a, -1, this._load_mode)
                    } while (o > i && this._loaded[r(o)]);
                    if (a <= i) return !1;
                    for (t.$ajax.get(e + "&from=" + r(i) + "&to=" + r(a), n); i < a;) this._loaded[r(i)] = !0,
            ...
            canParse: function (e, i) {
                ...
                try {
                    var n = t.$ajax.parse(i.responseText), a = t.$ajax.xmltop("data", n);
                ...
                var i;
                if (e.xmlDoc.responseXML || (e.xmlDoc.responseXML = t.$ajax.parse(e.xmlDoc.responseText)), i = t.$ajax.xmltop("data", e.xmlDoc),
                "data" != i.tagName) return null;
                var n = i.getAttribute("dhx_security");
                n && (window.dhtmlx && (dhtmlx.security_key = n), t.security_key = n);
                for (var a = t.$ajax.xpath("//coll_options", e.xmlDoc), r = 0; r < a.length; r++) {
                    var s = a[r].getAttribute("for"), o = t.serverList[s];
                    o || (t.serverList[s] = o = []), o.splice(0, o.length);
                    for (var d = t.$ajax.xpath(".//item", a[r]), _ = 0; _ < d.length; _++) {
                ...
                a.length && t.callEvent("onOptionsLoad", []);
            ...
            canParse: function (t) {
                ...
                var n = e && e.collections ? e.collections : {}, a = !1;
                for (var r in n) if (n.hasOwnProperty(r)) {
                    a = !0
                    ;var s = n[r], o = t.serverList[r];
                    o || (t.serverList[r] = o = []), o.splice(0, o.length);
                    for (var d = 0; d < s.length; d++) {
                        var _ = s[d], l = {key: _.value, label: _.label};
                        for (var h in _) if (_.hasOwnProperty(h)) {
            ...
            }, parse_date: function (e, i, n) {
                var a = e.split("T"), r = !1;
                a[1] && (i = a[1].substr(0, 2), n = a[1].substr(2, 2), r = !("Z" != a[1][6]));
                var s = a[0].substr(0, 4), o = parseInt(a[0].substr(4, 2), 10) - 1, d = a[0].substr(6, 2)
                ;
                return t.config.server_utc || r ? new Date(Date.UTC(s, o, d, i, n)) : new Date(s, o, d, i, n)
            ...
            var i = [];
            "string" == typeof e && (e = JSON.parse(e)), i = "[object Array]" === Object.prototype.toString.call(e) ? e : e ? e.data : [], i = i || [],
            e.dhx_security && (window.dhtmlx && (dhtmlx.security_key = e.dhx_security), t.security_key = e.dhx_security);
            var n = e && e.collections ? e.collections : {}, a = !1;
            for (var r in n) if (n.hasOwnProperty(r)) {
                a = !0;
                var s = n[r], o = t.serverList[r];
            ...
            var i = this.config.lightbox.sections, n = 0;
            for (n; n < i.length && i[n].name != e; n++) ;
            var a = i[n];
            t._lightbox || t.getLightbox();
            var r = document.getElementById(a.id), s = r.nextSibling, o = {
                section: a, header: r, node: s, getValue: function (e) {
                    return t.form_blocks[a.type].get_value(s, e || {}, a)
                }, setValue: function (e, i) {
                    return t.form_blocks[a.type].set_value(s, e, i || {}, a)
                }
            }, d = t._lightbox_controls["get_" + a.type + "_control"];
            return d ? d(o) : o
            ...
            template: {
                render: function (e) {
                    var i = t._lightbox_controls.defaults.template, n = i ? i.height : 30;
                ...
                render: function (e) {
                    var i = t._lightbox_controls.defaults.textarea, n = i ? i.height : 200;
                    return "<div class='dhx_cal_ltext' style='height:" + (e.height || n || "130") + "px;'><textarea></textarea></div>"
                }, set_value: function (e, i, n) {
                ...
                render: function (e) {
                    for (var i = t._lightbox_controls.defaults.select, n = i ? i.height : 23, a = (e.height || n || "23") + "px", r = "<div class='dhx_cal_ltext' style='height:" + a + ";'><select style='width:100%;'>", s = 0; s < e.options.length; s++) r += "<option value='" + e.options[s].key + "'>" + e.options[s].label + "</option>";
                    return r += "</select></div>"
                }, set_value: function (t, e, i, n) {
                    var a = t.firstChild;
                ...
                render: function (e) {
                    ...
                    var i = e.time_format, n = t.config, a = t.date.date_part(t._currentDate()), r = 1440, s = 0;
                    t.config.limit_time_select && (r = 60 * n.last_hour + 1,
                        s = 60 * n.first_hour, a.setHours(n.first_hour));
                    for (var o = "", d = 0; d < i.length; d++) {
                        ...
                        switch (_) {
                            case"%Y":
                                ...
                                for (var c = a.getFullYear() - 5, u = 0; u < 10; u++) h += "<option value='" + (c + u) + "'>" + (c + u) + "</option>";
                                break;
                            case"%m":
                            ...
                            case"%H:%i":
                                ...
                                for (e._time_values = []; u < r;) {
                                    h += "<option value='" + u + "'>" + this.templates.time_picker(a) + "</option>", e._time_values.push(u), a.setTime(a.valueOf() + 60 * this.config.time_step * 1e3);
                                    u = 24 * (a.getDate() != g ? 1 : 0) * 60 + 60 * a.getHours() + a.getMinutes()
                                }
                        }
                        if (h) {
                    ...
                    var s, o, d = t.config, _ = e.getElementsByTagName("select"), l = a._time_format_order;
                    if (d.full_day) {
                        if (!e._full_day) {
                            var h = "<label class='dhx_fullday'><input type='checkbox' name='full_day' value='true'> " + t.locale.labels.full_day + "&nbsp;</label></input>";
                            t.config.wide_form || (h = e.previousSibling.innerHTML + h), e.previousSibling.innerHTML = h,
                                e._full_day = !0
                        }
                        var c = e.previousSibling.getElementsByTagName("input")[0];
                        c.checked = 0 === t.date.time_part(n.start_date) && 0 === t.date.time_part(n.end_date), _[l[0]].disabled = c.checked, _[l[0] + _.length / 2].disabled = c.checked, c.onclick = function () {
                            if (c.checked) {
                                var i = {};
                                t.form_blocks.time.get_value(e, i, a), s = t.date.date_part(i.start_date), o = t.date.date_part(i.end_date), (+o == +s || +o >= +s && (0 !== n.end_date.getHours() || 0 !== n.end_date.getMinutes())) && (o = t.date.add(o, 1, "day"))
                            } else s = null, o = null
                            ;
                            _[l[0]].disabled = c.checked, _[l[0] + _.length / 2].disabled = c.checked, r(_, 0, s || n.start_date), r(_, 4, o || n.end_date)
                        }
                    }
                    if (d.auto_end_date && d.event_duration) for (var u = function () {
                    ...
                    r(_, 0, n.start_date), r(_, 4, n.end_date)
                }, get_value: function (e, i, n) {
                    var a = e.getElementsByTagName("select"), r = n._time_format_order
                    ;
                    if (i.start_date = new Date(a[r[3]].value, a[r[2]].value, a[r[1]].value, 0, a[r[0]].value), i.end_date = new Date(a[r[3] + 4].value, a[r[2] + 4].value, a[r[1] + 4].value, 0, a[r[0] + 4].value), !a[r[3]].value || !a[r[3] + 4].value) {
            ...
            var n = this.getEvent(e), a = i.getElementsByTagName("span"), r = [];
            if (t.templates.lightbox_header) {
                r.push("");
                var s = t.templates.lightbox_header(n.start_date, n.end_date, n);
                r.push(s), a[1].innerHTML = "", a[2].innerHTML = s
            } else {
                var o = this.templates.event_header(n.start_date, n.end_date, n),
                    d = (this.templates.event_bar_text(n.start_date, n.end_date, n) || "").substr(0, 70);
                r.push(o), r.push(d), a[1].innerHTML = o, a[2].innerHTML = d
            }
            this._waiAria.lightboxHeader(i, r.join(" "))
            ;
            for (var _ = this.config.lightbox.sections, l = 0; l < _.length; l++) {
                var h = _[l], c = t._get_lightbox_section_node(h), u = this.form_blocks[h.type],
                    g = void 0 !== n[h.map_to] ? n[h.map_to] : h.default_value;
                u.set_value.call(this, c, g, n, h), _[l].focus && u.focus.call(this, c)
            }
            t._lightbox_id = e
            ...
            var i = t._lightbox_id, n = this.getEvent(i);
            this.getLightbox();
            this._lame_copy(n, e), this.setEvent(n.id, n), this._edit_stop_event(n, !0), this.render_view_data()
            ...
            var i = i || t.getLightbox(), n = t.getEvent(this._lightbox_id);
        ...
        t._init_lightbox_events = function () {
            this.getLightbox().onclick = function (e) {
                ...
                if (i.className || (i = i.previousSibling), !(i && i.className && t._getClassName(i).indexOf("dhx_btn_set") > -1) || (i = i.querySelector("[dhx_button]"))) {
                    var n = t._getClassName(i);
                    if (i && n) switch (n) {
                        case"dhx_save_btn":
                            t.save_lightbox();
                            break;
                        case"dhx_delete_btn":
                            var a = t.locale.labels.confirm_deleting;
                            t._dhtmlx_confirm(a, t.locale.labels.title_confirm_deleting, function () {
                        ...
                        case"dhx_cancel_btn":
                            ...
                            break;
                        default:
                            if (i.getAttribute("dhx_button")) t.callEvent("onLightboxButton", [n, i, e]); else {
                                var r, s, o;
                                -1 != n.indexOf("dhx_custom_button") && (-1 != n.indexOf("dhx_custom_button_") ? (r = i.parentNode.getAttribute("index"), o = i.parentNode.parentNode) : (r = i.getAttribute("index"), o = i.parentNode, i = i.firstChild)), r && (s = t.form_blocks[t.config.lightbox.sections[r].type], s.button_click(r, i, o, o.nextSibling))
                            }
                    }
                }
            },
                this.getLightbox().onkeydown = function (e) {
                    var i = e || window.event, n = e.target || e.srcElement, a = n.querySelector("[dhx_button]");
                    switch (a || (a = n.parentNode.querySelector(".dhx_custom_button, .dhx_readonly")), (e || i).keyCode) {
                        case 32:
                        ...
                        case t.keys.edit_save:
                            if ((e || i).shiftKey) return;
                            a && a.click ? a.click() : t.save_lightbox();
                            break;
            ...
            t.event(document.body, "mousemove", t._move_while_dnd), t.event(document.body, "mouseup", t._finish_dnd), t._init_dnd_events = function () {
            }
            ...
            if (!this._lightbox) {
                ...
                ;
                for (var i = this._lightbox_template, n = this.config.buttons_left, a = "", r = 0; r < n.length; r++) a = this._waiAria.lightboxButtonAttrString(n[r]), i += "<div " + a + " class='dhx_btn_set dhx_left_btn_set " + n[r] + "_set'><div dhx_button='1' class='" + n[r] + "'></div><div>" + t.locale.labels[n[r]] + "</div></div>";
                n = this.config.buttons_right;
                for (var r = 0; r < n.length; r++) a = this._waiAria.lightboxButtonAttrString(n[r]),
                    i += "<div " + a + " class='dhx_btn_set dhx_right_btn_set " + n[r] + "_set' style='float:right;'><div dhx_button='1' class='" + n[r] + "'></div><div>" + t.locale.labels[n[r]] + "</div></div>";
                ...
                for (var r = 0; r < s.length; r++) {
                    ...
                    if (o) {
                        ...
                        var d = "";
                        if (s[r].button) {
                            var a = t._waiAria.lightboxSectionButtonAttrString(this.locale.labels["button_" + s[r].button]);
        ...
        t._bindLightboxLabels = function (e) {
            for (var i = 0; i < e.length; i++) {
                ...
                if (n.id && document.getElementById(n.id)) {
                    for (var a = document.getElementById(n.id), r = a.querySelector("label"), s = t._get_lightbox_section_node(n); s && !s.querySelector;) s = s.nextSibling;
                    var o = !0;
                    if (s) {
                        var d = s.querySelector("input, select, textarea");
                        d && (n.inputId = d.id || "input_" + t.uid(), d.id || (d.id = n.inputId), r.setAttribute("for", n.inputId), o = !1)
                    }
                    if (o) {
                        t.form_blocks[n.type].focus && (r.onclick = function (e) {
                            return function () {
                                var i = t.form_blocks[e.type], n = t._get_lightbox_section_node(e);
                                i && i.focus && i.focus.call(t, n)
                            }
                        }(n))
                    }
                }
            ...
            function r(e, i, n, a) {
                ...
                var s = Math.abs(e.pageY - i.pageY), o = Math.abs(e.pageX - i.pageX);
                return s < a && o > n && (!s || o / s > 3) && (e.pageX > i.pageX ? t._click.dhx_cal_next_button() : t._click.dhx_cal_prev_button(), !0)
            }

            function s(e) {
                if (!n(e)) {
                    var i = t.getState().drag_mode, a = !!t.matrix && t.matrix[t._mode], r = t.render_view_data;
                    return "create" == i && a && (t.render_view_data = function () {
                        for (var e = t.getState().drag_id, i = t.getEvent(e), n = a.y_property, r = t.getEvents(i.start_date, i.end_date), s = 0; s < r.length; s++) r[s][n] != i[n] && (r.splice(s, 1), s--)
                        ;
                        i._sorder = r.length - 1, i._count = r.length, this.render_data([i], t.getState().mode)
                    }), t._on_mouse_move(e), "create" == i && a && (t.render_view_data = r), e.preventDefault && e.preventDefault(), e.cancelBubble = !0, !1
                }
            }

            function o(e) {
                n(e) || (t._hide_global_tip(), h && (t._on_mouse_up(i(e || event)), t._temp_touch_block = !1), t._drag_id = null, t._drag_mode = null, t._drag_pos = null, t._pointerDragId = null, clearTimeout(l), h = u = !1, c = !0)
            }
            ...
            a(document.body, e[0], function (e) {
                if (!n(e)) {
                    var a = i(e);
                    if (a) {
                        if (h) return s(a), e.preventDefault && e.preventDefault(), e.cancelBubble = !0, t._update_global_tip(), !1;
            ...
            }), a(this._els.dhx_cal_data[0], "touchcancel", o),
                a(this._els.dhx_cal_data[0], "contextmenu", function (t) {
                    if (!n(t)) return u ? (t && t.preventDefault && t.preventDefault(), (t || event).cancelBubble = !0, !1) : void 0
                }), a(this._obj, e[1], function (e) {
                if (!n(e)) {
                    t._pointerDragId = e.pointerId;
                    var a;
                    if (h = c = !1, u = !0, !(a = _ = i(e))) return void (c = !0);
                    var r = new Date;
                    if (!c && !h && r - g < 250) return t._click.dhx_cal_data(a), window.setTimeout(function () {
                        a.type = "dblclick", t._on_dbl_click(a)
                    }, 50), e.preventDefault && e.preventDefault(), e.cancelBubble = !0, t._block_next_stop = !0, !1;
                    if (g = r,
                    !c && !h && t.config.touch_drag) {
                        var s = t._locate_event(document.activeElement), o = t._locate_event(a.target),
                            f = d ? t._locate_event(d.target) : null;
                        if (s && o && s == o && s != f) return e.preventDefault && e.preventDefault(), e.cancelBubble = !0, t._ignore_next_click = !1, t._click.dhx_cal_data(a), d = a, !1;
                        l = setTimeout(function () {
                            h = !0;
                            var e = d.target, i = t._getClassName(e);
                        ...
                        }, t.config.touch_drag), d = a
                    }
                }
            }), a(this._els.dhx_cal_data[0], e[2], function (e) {
                if (!n(e)) return !h && r(d, _, 200, 100) && (t._block_next_stop = !0), h && (t._ignore_next_click = !0, setTimeout(function () {
        ...
        t._show_global_tip = function () {
            ...
            if (i) {
                var n = "";
                if (t._drag_id && !e) {
                    var a = t.getEvent(t._drag_id);
                    a && (n = "<div>" + (a._timed ? t.templates.event_header(a.start_date, a.end_date, a) : t.templates.day_date(a.start_date, a.end_date, a)) + "</div>")
                }
                "create" == t._drag_mode || "new-size" == t._drag_mode ? i.innerHTML = (t.locale.labels.drag_to_create || "Drag to create") + n : i.innerHTML = (t.locale.labels.drag_to_move || "Drag to move") + n
            }
            ...
            e._methods = ["_set_event_text_style", "", "_dp_change_event_id", "_dp_hook_delete"], this._dp_change_event_id = function (e, i) {
                ...
                this._dp_hook_delete = function (i, n) {
                    if (t.getEvent(i)) return n && i != n && ("true_deleted" == this.getUserData(i, e.action_param) && this.setUserData(i, e.action_param, "updated"), this.changeEventId(i, n)), this.deleteEvent(n, !0)
            ...
            }), e._objToJson = function (t, i, n) {
                n = n || "", i = i || {}
                ;
                for (var a in t) 0 !== a.indexOf("_") && (t[a] && t[a].getUTCFullYear ? i[n + a] = this.obj._helpers.formatDate(t[a]) : t[a] && "object" == typeof t[a] ? e._objToJson(t[a], i, n + a + ".") : i[n + a] = t[a]);
                return i
            }, e._getRowData = function (t, e) {
                var i = this.obj.getEvent(t);
                return this._objToJson(i)
            }, e._clearUpdateFlag = function () {
            }, e.attachEvent("insertCallback", t._update_callback), e.attachEvent("updateCallback", t._update_callback), e.attachEvent("deleteCallback", function (t, e) {
            ...
            if (t.getEvent(e)) {
                ...
                n._text_style = i, this.event_updated(n)
            }
        },t._update_callback = function (e, i) {
            var n = t._xmlNodeToJSON(e.firstChild);
            "none" == n.rec_type && (n.rec_pattern = "none"), n.text = n.text || n._tagvalue, n.start_date = t._helpers.parseDate(n.start_date), n.end_date = t._helpers.parseDate(n.end_date), t.addEvent(n), t._add_rec_marker && t.setCurrentView()
        },t._skin_settings = {
            ...
            if (!t.skin) for (var e = document.getElementsByTagName("link"), i = 0; i < e.length; i++) {
                var n = e[i].href.match("dhtmlxscheduler_([a-z]+).css");
                if (n) {
                    t.skin = n[1];
                    break
                }
            ...
            var a = 0;
            if (!t.skin || "classic" !== t.skin && "glossy" !== t.skin || (a = 1), t._is_material_skin()) {
                var r = t.config.buttons_left.$inital, s = t.config.buttons_right.$inital;
            ...
            if (this._configure(t.config, t._skin_settings, a), this._configure(t.xy, t._skin_xy, a), "flat" === t.skin && (t.xy.scale_height = 35, t.templates.hour_scale = function (t) {
                var e = t.getMinutes();
                return e = e < 10 ? "0" + e : e, "<span class='dhx_scale_h'>" + t.getHours() + "</span><span class='dhx_scale_m'>&nbsp;" + e + "</span>"
            }), !a) {
                var d = t.config.minicalendar
                ;d && (d.padding = 14), t.templates.event_bar_date = function (e, i, n) {
                    ...
                    if (t.templates.month_day = function (n) {
                        if ("month" == this._mode) {
                            var a = e(n);
                            return 1 == n.getDate() && (a = t.locale.date.month_full[n.getMonth()] + " " + a),
                            +n == +t.date.date_part(this._currentDate()) && (a = t.locale.labels.dhx_cal_today_button + " " + a), a
                        }
                        return i.call(this, n)
                    }, t.config.fix_tab_position) {
                        var n = t._els.dhx_cal_navline[0].getElementsByTagName("div"), a = null, r = 211,
                            s = [14, 75, 136], o = 14;
                        t._is_material_skin() && (s = [16, 103, 192], r = 294, o = -1);
                        for (var d = 0; d < n.length; d++) {
                            var _ = n[d], l = _.getAttribute("name");
                            if (l) {
                                ...
                                _.className += " " + l
                            } else 0 === (_.className || "").indexOf("dhx_minical_icon") && _.parentNode == t._els.dhx_cal_navline[0] && (a = _)
                        }
                        a && (a.style.left = r + "px")
                    }
                }), t._skin_init = function () {
            ...
            var i = t.setCurrentView, n = t.updateView, a = null, r = null, s = function (i, s) {
                var o = this;
                window.clearTimeout(r), window.clearTimeout(a);
                var d = o._date, _ = o._mode;
                e(this, i, s), r = setTimeout(function () {
                    if (!o.callEvent("onBeforeViewChange", [_, d, s || o._mode, i || o._date])) return void e(o, d, _);
                    n.call(o, i, s), o.callEvent("onViewChange", [o._mode, o._date]), window.clearTimeout(a), r = 0
                }, t.config.delay_render)
            }, o = function (i, s) {
                var o = this, d = arguments;
                e(this, i, s), window.clearTimeout(a), a = setTimeout(function () {
                    r || n.apply(o, d)
                }, t.config.delay_render)
            };
            t.attachEvent("onSchedulerReady", function () {
                t.config.delay_render ? (t.setCurrentView = s, t.updateView = o) : (t.setCurrentView = i, t.updateView = n)
            })
        }()
        ;
        for (var s = 0; s < Scheduler._schedulerPlugins.length; s++) Scheduler._schedulerPlugins[s](t);
