...
;for(var i,a=e._waiAria.agendaDataAttrString(),n="<div class='dhx_agenda_area' "+a+">",r=0;r<t.length;r++){var s=t[r],o=s.color?"background:"+s.color+";":"",d=s.textColor?"color:"+s.textColor+";":"",l=e.templates.event_class(s.start_date,s.end_date,s);i=e._waiAria.agendaEventAttrString(s);var _=e._waiAria.agendaDetailsBtnString()
;n+="<div "+i+" class='dhx_agenda_line"+(l?" "+l:"")+"' event_id='"+s.id+"' style='"+d+o+(s._text_style||"")+"'><div class='dhx_agenda_event_time'>"+e.templates.agenda_time(s.start_date,s.end_date,s)+"</div>",n+="<div "+_+" class='dhx_event_icon icon_details'>&nbsp;</div>",n+="<span>"+e.templates.agenda_text(s.start_date,s.end_date,s)+"</span></div>"}n+="<div class='dhx_v_border'></div></div>",e._els.dhx_cal_data[0].innerHTML=n,e._els.dhx_cal_data[0].childNodes[0].scrollTop=e._agendaScrollTop||0
