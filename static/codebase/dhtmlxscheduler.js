        ...
        scheduler._on_dbl_click = function (e, src) {
            ...
            switch (name) {
                ...
                case "dhx_wa_day_data":
                    ...
                    this.callEvent("onEmptyDblClick", [this.getActionData(e).date, e]);
        ...
        scheduler._on_mouse_move = function (e) {
            if (this._drag_mode) {
                ...
                if (this._is_pos_changed(this._drag_pos, pos)) {
                    ...
                    if (!this._table_view &&
                        !scheduler.config.all_timed &&
                        ((!scheduler.getView() && pos.x != this._get_event_sday({
...
// non-primitive number object, e.g. new Boolean(true)
        ...
        scheduler.locale = {
            ...
            labels: {
                ...
                confirm_deleting: "Event in this week will be deleted, are you sure?",
